function Volume=voxelateMesh(FV,VolumeSize,mode,Yxz)
% This function voxelateMesh will convert a Triangulated Mesh into a
...
%
% Volume=convMesh2Voxel(FV,VolumeSize,Mode,Yxz);
%
% Inputs,
...
% Modified by Alistair Jones, RMIT University 2022
